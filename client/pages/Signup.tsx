          ...
          <div className="mx-auto max-w-md">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">
                Join SamasyaSamadhan
              </h1>
              <p className="text-white/80">
                Create your account and start your journey towards better mental health
              </p>
            </div>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  <p className="text-xs text-blue-800">
                    🔒 Your privacy is our priority. We'll never share your personal information, 
                    and all your conversations with experts are completely confidential.
                  </p>
                </div>
              </CardContent>
            </Card>
