...
आपके लक्षणों को देखते हु���, लगता है कि आपको:
...
- अप��े विचारों को डायरी में लिखें
...
- Unnecessary subscriptions cancel क��ें
...
Life direction और purpose की confusion होना बिल्कुल normal है। आ�� अकेले नहीं हैं इस feeling में।
