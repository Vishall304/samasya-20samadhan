...
export default function AIResponseChat({
  ...
  const generateAIResponse = (problem: string, cat: string, user: any) => {
    ...
    const responses: { [key: string]: { hindi: string; hinglish: string; english: string } } = {
...
- 4-7-8 तकनीक: 4 ��ेकंड सांस लें, 7 सेकंड रोकें, 8 सेकंड में छोड़ें
...
- दूसरे की परिस्थिति समझने की कोश��श करें
...
- हर घंटे में 5 मिनट stretch करे���
